  ...
  group('SvgUtils', () {
    group('SVG Validation', () {
      test('isSvg should correctly identify SVG data', () {
        // Test data
        final validSvg = Uint8List.fromList(
          utf8.encode('''
        ...
        final validSvgSingleQuotes = Uint8List.fromList(
          utf8.encode('''
          <svg xmlns='http://www.w3.org/2000/svg' width='100' height='100'>
            <circle cx='50' cy='50' r='40' stroke='black' stroke-width='3' fill='red' />
          </svg>
        ...
        final validSvgNoNamespace = Uint8List.fromList(
          utf8.encode('''
    ...
    group('SVG Dimension Extraction', () {
      test('getSvgSize should extract correct dimensions from SVG', () {
        // Test data
        final svgWithDimensions = Uint8List.fromList(
          utf8.encode('''
        ...
        final svgWithUnits = Uint8List.fromList(
          utf8.encode('''
        ...
        final svgWithViewBox = Uint8List.fromList(
          utf8.encode('''
        ...
        final svgNoDimensions = Uint8List.fromList(
          utf8.encode('''
        ...
        // Assertions
        expect(
          SvgUtils.getSvgSize(svgWithDimensions),
          equals(const Size(200, 150)),
          reason: 'Should extract explicit dimensions',
        );

        expect(
          SvgUtils.getSvgSize(svgWithUnits),
          equals(const Size(200, 150)),
